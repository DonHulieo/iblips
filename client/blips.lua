...
---@field setcolours fun(blip: integer, alpha: integer?, primary: integer?, secondary: {r: integer, g: integer, b: integer}?)
...
---@field setflashes fun(blip: integer, flashes: boolean, flash_interval: integer?, flash_duration: integer?)
